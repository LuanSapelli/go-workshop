...
type debt struct {
	...
	Status       int       `gorm:"type:varchar(10)" json:"status"`
	NewCreatedAt time.Time `gorm:"default:NOW()" json:"created_at"`
	NewUpdatedAt time.Time `gorm:"default:NOW()" json:"updated_at"`
}
